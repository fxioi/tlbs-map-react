...
var MultiLabelComponent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var id = props.id,
  ...
  /**  初始化文本标记图层 */
  var initMultiLabel = function initMultiLabel() {
    if (!map) return;
    var multiLabelInstance = new TMap.MultiLabel({
      id: id,
      zIndex: zIndex,
      map: map,
  ...
  // @hook 监听样式改变
  useEffect(function () {
    instance === null || instance === void 0 || instance.setStyles(getStyle('label', styles));
  }, [styles]);
