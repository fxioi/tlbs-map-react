...
var MultiPolygonComponent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var id = props.id,
  ...
  var _useState = useState(),
    ...
    setInstance = _useState2[1]; // 存储多边形图层实例

  /** 初始化多边形图层 */
  var initMultiPolygon = function initMultiPolygon() {
    if (!map) return;
    var multiPolygonInstance = new TMap.MultiPolygon({
      id: id,
      map: map,
      zIndex: zIndex,
  ...
  // @hook 监听样式改变
  useEffect(function () {
    instance === null || instance === void 0 || instance.setStyles(getStyle('polygon', styles));
  }, [styles]);
