...
var AreaComponent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var _ref = props,
    _ref$data = _ref.data,
  ...
  var _useState = useState(),
    ...
    setInstance = _useState2[1]; // 存储图层实例

  /** 初始化区域图图层 */
  var initArea = function initArea() {
    if (!map) return;
    var areaInstance = new TMap.visualization.Area({
      styles: styles,
