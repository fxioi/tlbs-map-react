...
var MultiMarkerComponent = /*#__PURE__*/React.forwardRef(function (props, ref) {
  var id = props.id,
  ...
  var zIndex = options.zIndex,
    ...
    collisionOptions = options.collisionOptions,
  ...
  var _useState = useState(),
    ...
    setInstance = _useState2[1]; // 存储点标记图层实例

  /** 初始化点标记图层 */
  var initMultiMarker = function initMultiMarker() {
    if (!map) return;
    var multiMakerInstance = new TMap.MultiMarker({
      id: id,
      map: map,
      zIndex: zIndex,
  ...
  useEffect(function () {
    ...
    return function () {
      instance === null || instance === void 0 || instance.setMap(null); // 将多个标注点同时从地图中移除
    };
  }, [map, instance]);
  ...
  // @hook 监听样式改变
  useEffect(function () {
    instance === null || instance === void 0 || instance.setStyles(getStyle('marker', styles));
  }, [styles]);
